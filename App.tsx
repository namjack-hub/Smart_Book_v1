...
import { Settings, Search, BookOpen, Star, TrendingUp, ArrowRight, Sparkles, Download, Loader2, AlertCircle, Key, Library, BookCopy, Zap, Award, RotateCcw } from 'lucide-react';
...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      console.error(error);
      alert("AI 분석에 실패했습니다. 잠시 후 다시 시도해주세요. API KEY를 확인하세요.");
    } finally {
